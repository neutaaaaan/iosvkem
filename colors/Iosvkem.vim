...
" Last Updated: Tue 20 Aug 2019 11:49:54 AM CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1b1d1e', '#d02b61', '#60aa00', '#d08928',
        \ '#6c9ef8', '#b77fdb', '#00aa80', '#dddddd', '#707070', '#d02b61',
        \ '#60aa00', '#d08928', '#6c9ef8', '#b77fdb', '#00aa80', '#ffffff']
  if get(g:, 'Iosvkem_transp_bg', 0) && !has('gui_running')
    ...
    hi Normal guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
    hi Terminal guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  endif
  hi ColorColumn guifg=NONE guibg=#161819 guisp=NONE gui=NONE cterm=NONE
  ...
  hi CursorLineNr guifg=#20bbfc guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi DiffAdd guifg=#40bb40 guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi DiffChange guifg=#80aacc guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi DiffDelete guifg=#cc4040 guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi DiffText guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi Directory guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi FoldColumn guifg=#dddddd guibg=#161819 guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=italic cterm=italic
  hi IncSearch guifg=#fcbb20 guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi LineNr guifg=#505050 guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#fc20bb guibg=#1b1d1e guisp=NONE gui=bold cterm=bold
  hi ModeMsg guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi MoreMsg guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#dddddd guibg=#303030 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi PmenuSel guifg=#fc20bb guibg=#303030 guisp=NONE gui=bold cterm=bold
  hi PmenuThumb guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#20bbfc guibg=#1b1d1e guisp=NONE gui=reverse cterm=reverse
  hi SignColumn guifg=#dddddd guibg=#161819 guisp=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi SpellBad guifg=#fc20bb guibg=#1b1d1e guisp=NONE gui=underline cterm=underline
  hi SpellCap guifg=#20bbfc guibg=#1b1d1e guisp=NONE gui=underline cterm=underline
  hi SpellLocal guifg=#bb20fc guibg=#1b1d1e guisp=NONE gui=underline cterm=underline
  hi SpellRare guifg=#20fcbb guibg=#1b1d1e guisp=NONE gui=underline cterm=underline
  hi StatusLine guifg=#dddddd guibg=#303030 guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#505050 guibg=#161819 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Title guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#505050 guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  ...
  hi Constant guifg=#60aa00 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Error guifg=#ff2040 guibg=#1b1d1e guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi Identifier guifg=#b77fdb guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#dddddd guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#5688af guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#d02b61 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#6c9ef8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#d08928 guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#20fcbb guibg=NONE guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#00aa80 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Underlined guifg=#dddddd guibg=NONE guisp=NONE gui=underline cterm=underline
  hi CursorIM guifg=#1b1d1e guibg=#bbfc20 guisp=NONE gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#1b1d1e guisp=NONE gui=NONE cterm=NONE
  hi ToolbarButton guifg=#dddddd guibg=#1b1d1e guisp=NONE gui=bold cterm=bold
  ...
  hi markdownListMarker guifg=#b77fdb guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi markdownId guifg=#00aa80 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi markdownIdDeclaration guifg=#00aa80 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi rstCitationReference guifg=#00aa80 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, "Iosvkem_disable_italic", 0)
    ...
    hi markdownBoldItalic cterm=bold,underline
...
if s:t_Co >= 256
  if get(g:, 'Iosvkem_transp_bg', 0)
    ...
    hi Terminal ctermfg=253 ctermbg=234 cterm=NONE
  endif
  ...
  hi CursorLineNr ctermfg=39 ctermbg=234 cterm=NONE
  hi DiffAdd ctermfg=34 ctermbg=234 cterm=reverse
  hi DiffChange ctermfg=110 ctermbg=234 cterm=reverse
  hi DiffDelete ctermfg=167 ctermbg=234 cterm=reverse
  hi DiffText ctermfg=253 ctermbg=234 cterm=reverse
  hi Directory ctermfg=253 ctermbg=234 cterm=NONE
  hi EndOfBuffer ctermfg=253 ctermbg=234 cterm=NONE
  hi ErrorMsg ctermfg=253 ctermbg=234 cterm=reverse
  ...
  hi Pmenu ctermfg=253 ctermbg=236 cterm=NONE
  hi PmenuSbar ctermfg=253 ctermbg=234 cterm=NONE
  hi PmenuSel ctermfg=199 ctermbg=236 cterm=bold
  hi PmenuThumb ctermfg=253 ctermbg=234 cterm=NONE
  hi Question ctermfg=253 ctermbg=234 cterm=NONE
  hi Search ctermfg=39 ctermbg=234 cterm=reverse
  hi SignColumn ctermfg=253 ctermbg=233 cterm=NONE
  hi SpecialKey ctermfg=253 ctermbg=234 cterm=NONE
  hi SpellBad ctermfg=199 ctermbg=234 cterm=underline
  hi SpellCap ctermfg=39 ctermbg=234 cterm=underline
  hi SpellLocal ctermfg=129 ctermbg=234 cterm=underline
  hi SpellRare ctermfg=49 ctermbg=234 cterm=underline
  hi StatusLine ctermfg=253 ctermbg=236 cterm=NONE
  ...
  hi Title ctermfg=253 ctermbg=234 cterm=NONE
  ...
  hi String ctermfg=172 ctermbg=234 cterm=NONE
  ...
  hi CursorIM ctermfg=234 ctermbg=154 cterm=NONE
  hi ToolbarLine ctermfg=NONE ctermbg=234 cterm=NONE
  hi ToolbarButton ctermfg=253 ctermbg=234 cterm=bold
  ...
  hi markdownListMarker ctermfg=140 ctermbg=NONE cterm=bold
  ...
  hi markdownId ctermfg=36 ctermbg=NONE cterm=NONE
  hi markdownIdDeclaration ctermfg=36 ctermbg=NONE cterm=NONE
  ...
  hi rstCitationReference ctermfg=36 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 2
  ...
  hi Folded term=italic,underline
